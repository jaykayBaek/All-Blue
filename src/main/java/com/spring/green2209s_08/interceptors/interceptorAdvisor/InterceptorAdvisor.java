...
public class InterceptorAdvisor {
    ...
    public ResponseEntity<StatusResponse> interceptorExceptionHandler(InterceptorException e,
    ...
    public ResponseEntity<StatusResponse> vendorExceptionHandler(VendorAlreadyLoginException e,
                                      HttpServletRequest request, HttpServletResponse response) throws IOException {
